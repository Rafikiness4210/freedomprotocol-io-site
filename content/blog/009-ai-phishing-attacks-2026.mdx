...
Use a dedicated email address for crypto accounts — ideally ProtonMail with SimpleLogin aliases. One unique alias per exchange. If you receive a "Coinbase" email at an alias you only used for Kraken, it's instantly identifiable as phishing.
